...
namespace ExplorerSpace
{
    ...
    class InstanceView : IView
    {
        ...
        public InstanceView(ArrayList instanceViews = null)
        {
            //this.instanceViews = instanceViews;
            subViews = new ArrayList();
            subViews.Add(new InstanceFieldView());
            subViews.Add(new InstancePropView());
            subViews.Add(new InstanceMethodView());

            Add("GameMain", "none", typeof(GameMain), null);
        }

        public static void UpdateView(InstanceInfo instanceInfo)
        {
        ...
        public static void Add(string parent,string name,Type type, object instance = null)
        {
        ...
        public void DrawLeft()
        {
            ...
            if (ImGui.BeginTable("InstanceTable", 4, tableFlags))
            {
                ...
                ImGuiUtils.TableSetupColumn("Parent", "Type", "Name", "Close");
                ...
                foreach (InstanceInfo instance in instanceList)
                {
                    ...
                    ImGui.TableSetColumnIndex(0);
                    ImGui.Text(instance.parent);
                    ImGui.TableSetColumnIndex(1);
                    ImGui.Text(instance.type.Name);
