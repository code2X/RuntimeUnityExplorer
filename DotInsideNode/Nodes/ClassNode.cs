...
namespace DotInsideNode
{
    class ClassNode : NodeBase
    {
        ...
        TextTB m_TextTitleBar = new TextTB("Class");
        ComboCompo m_NodeCombo;
        TypeOC m_NodeTypeOutput;

        List<INodeComponent> nodeComponents = new List<INodeComponent>();
        ...
        public ClassNode()
        {
            ...
            m_NodeCombo = new ComboCompo(classList.Keys);
            m_NodeCombo.OnSelect += new ComboCompo.SelectHandler(OnClassSelect);
