...
{
    [Serializable]
    public abstract class IFunction : dnObject, IView
    {
        [Serializable]
        ...
        #region LocalVar
        public abstract IVarManager LocalVar
        {
            get;
        }
        #endregion

        #region ParamsInterface
        ...
        public virtual void OpenGraph(INodeGraphEditor graphEditor) { }
        public virtual void CloseGraph() { }
        public abstract IFunctionGraph GetGraph();

        [Serializable]
        protected class FunctionDefaultEditor : IView
        {
