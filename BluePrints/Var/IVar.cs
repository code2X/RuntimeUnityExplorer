...
{
    [Serializable]
    public abstract class IVar: dnObject, IView
    {
        #region Field
        ...
        [Serializable]
        public abstract class IVarEditor : IContainerEditor, IView
        {
        ...
        public class VarDefaultEditor : IVarEditor
        {
            ...
            public virtual bool TryRenameVar(ref string newName)
            {
                ...
                if (m_Var.Instance.ContainVar(newName))
                {
                ...
                {
                    //OnVarRename(newName);
                    Assert.IsTrue(VarManager.Instance.RenameVar(m_Var.ID, newName));
                    m_Var.Name = newName;
                    return true;
                }*/
            }
