...
{
    [Serializable]
    public abstract class IFunctionGraph: INodeGraph
    {
        public abstract LinkManager ngLinkManager { get; }
        public abstract NodeManager ngNodeManager { get; }
        public abstract EditorNodeComponentManager ngNodeComponentManager { get; }
    ...
    class FunctionGraph: IFunctionGraph
    {
        ...
        #region Serializing Deserialized
        [OnSerializing]
        ...
        {
            m_NodeComponentManager.NodeGraph = this;
        }
        #endregion
